...
import com.example.doancs3.Model.VNPayModel
import com.example.doancs3.R
import com.example.doancs3.Utilities.VNPayUtils
...
class CartActivity : BaseActivity() {
    ...
    private fun handleVNPayReturn(intent: Intent?) {
        ...
        if (data != null && data.scheme == "doancs3") {
